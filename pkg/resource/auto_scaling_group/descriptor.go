...
const (
	FinalizerString = "finalizers.autoscaling.services.k8s.aws/AutoScalingGroup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("autoscalinggroups")
	GroupKind            = metav1.GroupKind{
		Group: "autoscaling.services.k8s.aws",
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.AutoScalingGroup{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.AutoScalingGroup),
	}
}
